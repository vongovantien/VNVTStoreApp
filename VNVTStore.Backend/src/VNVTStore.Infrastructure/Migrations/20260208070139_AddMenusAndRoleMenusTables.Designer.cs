...
namespace VNVTStore.Infrastructure.Migrations
{
    ...
    [Migration("20260208070139_AddMenusAndRoleMenusTables")]
    partial class AddMenusAndRoleMenusTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VNVTStore.Domain.Entities.TblReview", b =>
                {
                    ...
                    b.Property<string>("ProductCodeNavigationCode")
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("ProductCodeNavigationCode");
            ...
            modelBuilder.Entity("VNVTStore.Domain.Entities.TblReview", b =>
                {
                    ...
                    b.HasOne("VNVTStore.Domain.Entities.TblProduct", "ProductCodeNavigation")
                        .WithMany()
                        .HasForeignKey("ProductCodeNavigationCode");
