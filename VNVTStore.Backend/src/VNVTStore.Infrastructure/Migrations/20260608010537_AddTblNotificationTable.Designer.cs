...
namespace VNVTStore.Infrastructure.Migrations
{
    ...
    [Migration("20260608010537_AddTblNotificationTable")]
    partial class AddTblNotificationTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VNVTStore.Domain.Entities.TblCartItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "CartCode", "ProductCode", "Size", "Color" }, "idx_cartitem_unique")
                        .IsUnique();
            ...
            modelBuilder.Entity("VNVTStore.Domain.Entities.TblNotification", b =>
                {
                    ...
                    b.HasKey("Code")
                        .HasName("TblNotification_pkey");

                    b.HasIndex(new[] { "UserCode" }, "idx_notification_user");
            ...
            modelBuilder.Entity("VNVTStore.Domain.Entities.TblSystemSecret", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("TblSystemSecret", (string)null);
                });
