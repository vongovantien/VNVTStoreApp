  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e19]:
      ...
      - generic [ref=e28]:
        ...
        - generic [ref=e30]:
          ...
          - textbox "Email" [ref=e35]:
            ...
            - text: security_test_1769236909940@example.com
      - generic [ref=e36]:
      ...
      - generic [ref=e69] [cursor=pointer]:
        - checkbox "Tôi đồng ý với Điều khoản sử dụng" [checked] [active] [ref=e70]
        - generic [ref=e71]:
          - text: Tôi đồng ý với
          - link "Điều khoản sử dụng" [ref=e72]:
            - /url: /terms
      - button "Đăng ký" [ref=e73] [cursor=pointer]:
        - text: Đăng ký
        - img [ref=e74]
    - generic [ref=e76]:
      - paragraph [ref=e77]: "Lợi ích khi đăng ký:"
      - list [ref=e78]:
        - listitem [ref=e79]:
          - img [ref=e80]
    ...
    - paragraph [ref=e88]:
      ...
      - link "Đăng nhập" [ref=e89] [cursor=pointer]:
        - /url: /login
  - link "← Về trang chủ" [ref=e91] [cursor=pointer]:
    - /url: /
```