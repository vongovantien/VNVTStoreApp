...
public class CategoriesHandlerTests
{
    ...
    public async Task Create_ShouldUploadImage_WhenBase64Provided()
    {
        ...
        _mockImageUploadService.Setup(s => s.UploadBase64Async(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(Result.Success(new FileDto { Url = "http://example.com/image.png" }));
    ...
    public async Task Update_ShouldUploadImage_WhenBase64Provided()
    {
        ...
        _mockImageUploadService.Setup(s => s.UploadBase64Async(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(Result.Success(new FileDto { Url = "http://example.com/new-image.png" }));
        ...
        // Assert.Null(oldFile.MasterCode); // Handler removes the file now instead of unlinking
        _mockContext.Verify(c => c.TblFiles.Remove(oldFile), Times.Once);
