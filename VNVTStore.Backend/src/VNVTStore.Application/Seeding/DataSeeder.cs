...
public static class DataSeeder
{
    public static async Task SeedAsync(IApplicationDbContext context, IPasswordHasher passwordHasher)
    {
        ...
        var defaultSecrets = new[]
        {
            ...
            new TblSystemSecret { Code = "DISABLE_EMAIL_VERIFICATION", SecretValue = "false", Description = "Disable email verification globally for the system (true/false)", IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new TblSystemSecret { Code = "CONTACT_PHONE", SecretValue = "0901234567", Description = "Số điện thoại Hotline liên hệ nhanh", IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new TblSystemSecret { Code = "CONTACT_FACEBOOK", SecretValue = "https://www.facebook.com/vnvtstore", Description = "Link trang Facebook của cửa hàng", IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new TblSystemSecret { Code = "CONTACT_TIKTOK", SecretValue = "https://www.tiktok.com/@vnvtstore", Description = "Link kênh TikTok của cửa hàng", IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
