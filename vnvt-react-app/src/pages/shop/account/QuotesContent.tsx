...
const QuotesContent = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {quotes.map((quote) => (
        <div key={quote.id} className="bg-primary rounded-xl p-4 border border-secondary/20 hover:shadow-md transition-shadow">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
            <div>
              <p className="font-semibold text-color-primary">#{quote.id.substring(0, 8)}</p>
