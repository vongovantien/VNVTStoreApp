    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 md:col-span-8 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 border-b pb-2">
              {t('common.priceAndStock') || 'Giá & Kho'}
            </h3>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 border-b pb-2">
              {t('common.specifications') || 'Thông số kỹ thuật'}
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <Input label="Màu sắc" {...register('color')} placeholder="VD: Trắng..." />
              <Input label="Chất liệu" {...register('material')} placeholder="VD: Nhựa PVC..." />
            </div>
            <div className="grid grid-cols-3 gap-4">
              <Input label="Công suất" {...register('power')} placeholder="VD: 50W..." />
              <Input label="Điện áp" {...register('voltage')} placeholder="VD: 220V..." />
              <Input label="Kích thước" {...register('size')} placeholder="VD: Ø20mm..." />
            </div>
          </div>
        </div>
