              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { name: 'MC', icon: CreditCard, color: 'text-red-600' },
                    { name: 'ZaloPay', icon: Wallet, color: 'text-blue-500' },
                    { name: 'MoMo', icon: Wallet, color: 'text-pink-600' },
                    { name: 'VNPAY', icon: Wallet, color: 'text-blue-700' },
                  ].map((method) => (
                    <div key={method.name} className="px-2 py-1 bg-white rounded text-xs font-bold text-gray-800 flex items-center gap-1" title={method.name}>
